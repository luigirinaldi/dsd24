...
module first_nios2_system_mm_interconnect_0 (
	...
	wire  [101:0] cpu_debug_mem_slave_agent_rf_source_data;                                  // cpu_debug_mem_slave_agent:rf_source_data -> cpu_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [101:0] cpu_debug_mem_slave_agent_rsp_fifo_out_data;                               // cpu_debug_mem_slave_agent_rsp_fifo:out_data -> cpu_debug_mem_slave_agent:rf_sink_data
	...
	wire  [100:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> cpu_debug_mem_slave_agent:cp_data
	...
	wire   [24:0] sys_clk_timer_s1_agent_m0_address;                                         // sys_clk_timer_s1_agent:m0_address -> sys_clk_timer_s1_translator:uav_address
	...
	wire  [101:0] sys_clk_timer_s1_agent_rf_source_data;                                     // sys_clk_timer_s1_agent:rf_source_data -> sys_clk_timer_s1_agent_rsp_fifo:in_data
	...
	wire  [101:0] sys_clk_timer_s1_agent_rsp_fifo_out_data;                                  // sys_clk_timer_s1_agent_rsp_fifo:out_data -> sys_clk_timer_s1_agent:rf_sink_data
	...
	wire  [100:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> sys_clk_timer_s1_agent:cp_data
	...
	wire  [101:0] led_pio_s1_agent_rf_source_data;                                           // led_pio_s1_agent:rf_source_data -> led_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [101:0] led_pio_s1_agent_rsp_fifo_out_data;                                        // led_pio_s1_agent_rsp_fifo:out_data -> led_pio_s1_agent:rf_sink_data
	...
	wire  [100:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> led_pio_s1_agent:cp_data
	...
	wire  [100:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [100:0] sys_clk_timer_s1_agent_rp_data;                                            // sys_clk_timer_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [100:0] led_pio_s1_agent_rp_data;                                                  // led_pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire   [82:0] sdram_s1_agent_rp_data;                                                    // sdram_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [100:0] router_src_data;                                                           // router:src_data -> cpu_data_master_limiter:cmd_sink_data
	...
	wire  [100:0] cpu_data_master_limiter_cmd_src_data;                                      // cpu_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [100:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> cpu_data_master_limiter:rsp_sink_data
	...
	wire  [100:0] cpu_data_master_limiter_rsp_src_data;                                      // cpu_data_master_limiter:rsp_src_data -> cpu_data_master_agent:rp_data
	...
	wire  [100:0] router_001_src_data;                                                       // router_001:src_data -> cpu_instruction_master_limiter:cmd_sink_data
	...
	wire  [100:0] cpu_instruction_master_limiter_cmd_src_data;                               // cpu_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [100:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> cpu_instruction_master_limiter:rsp_sink_data
	...
	wire  [100:0] cpu_instruction_master_limiter_rsp_src_data;                               // cpu_instruction_master_limiter:rsp_src_data -> cpu_instruction_master_agent:rp_data
	...
	wire   [82:0] router_007_src_data;                                                       // router_007:src_data -> sdram_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                      // sdram_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [5:0] router_007_src_channel;                                                    // router_007:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire  [100:0] sdram_s1_rsp_width_adapter_src_data;                                       // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          sdram_s1_rsp_width_adapter_src_ready;                                      // rsp_demux_005:sink_ready -> sdram_s1_rsp_width_adapter:out_ready
	wire    [5:0] sdram_s1_rsp_width_adapter_src_channel;                                    // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire  [100:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> sdram_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                     // sdram_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> sdram_s1_cmd_width_adapter:in_channel
	...
	first_nios2_system_mm_interconnect_0_router_002 router_005 (
	...
	first_nios2_system_mm_interconnect_0_router_007 router_007 (
	...
	first_nios2_system_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	first_nios2_system_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	first_nios2_system_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	first_nios2_system_mm_interconnect_0_rsp_demux_002 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
	...
	first_nios2_system_mm_interconnect_0_avalon_st_adapter_005 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
